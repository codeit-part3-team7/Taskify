  ...
  return (
    <>
      <div className="flex flex-col items-center justify-center">
        ...
        <div className="">
          <div className="flex items-end justify-between w-full pc:gap-200 h-600 rounded-8 mt-184 bg-gray-FAFA pl-60 pt-60">
            <div className="flex flex-col justify-center pc:gap-100 mb-223">
              <span className="font-medium leading-normal text-gray-9FA6 text-22 font-Pretendard">Point 1</span>
              <span className="font-bold leading-tight text-48 font-Pretendard">
                일의 우선순위를
                <br /> 관리하세요
              </span>
            </div>
            <Image
              className="h-auto w-295 tablet:w-520 pc:w-594"
              width={594}
              height={497}
          ...
          <div className="flex items-end w-full pc:justify-end pc:gap-100 pc:flex-row-reverse h-600 rounded-8 mt-90 bg-gray-FAFA pl-60 pt-60">
            <div className="flex flex-col justify-center pc:gap-100 mb-223">
              <span className="font-medium leading-normal text-gray-9FA6 text-22 font-Pretendard">Point 2</span>
              <span className="font-bold leading-tight text-48 font-Pretendard">
                해야할 일을
                <br /> 등록하세요
              </span>
            ...
            <Image
              className="h-auto w-217 tablet:w-360 pc:w-436"
              width={436}
              height={502}
          ...
          <div className="flex flex-col mt-90">
            <span className="font-bold font-Pretendard text-28">생산성을 높이는 다양한 설정 ⚡</span>
            <div className="grid grid-cols-3 gap-33 mt-42 tablet:mt-36">
